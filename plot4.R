...
plot(selectedRows$DateAndTime, selectedRows$Voltage,
...
## graph 3 - Note the bty = "n" to  get rid of legend box line
...
plot(selectedRows$DateAndTime, selectedRows$Global_reactive_power,
